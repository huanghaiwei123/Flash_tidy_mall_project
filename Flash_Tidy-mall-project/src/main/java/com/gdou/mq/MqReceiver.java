...
public class MqReceiver {
    ...
    public void orderHandle(MqOrderMessage orderMessage) {
        ...
        try {
            ...
            Long couponId = orderMessage.getCouponId();
            ...
            Order order = Order.builder()
                    ...
                    .createTime(new Date())
                    .addressSnapshot(objectMapper.writeValueAsString(orderMessage.getAddressSnapshot()))
    ...
    public void delayOrderHandle(MqOrderDelayMessage message) {
        ...
        log.info("订单{}十五分钟内用户未支付，已取消", message.getOrderNo());
    }
}